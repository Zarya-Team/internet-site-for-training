'use client'
import { $token, Token, setToken } from "../../store/user";
    ...
    <div className='container mx-auto mt-6 justify-center flex flex-col h-screen items-center'>
        <Formik 
            ...
            onSubmit={ async (values,{setErrors,setSubmitting}) => {
                ...
                try{
                    ...
                    // (await response).json().then(value => {setToken(value as Token)});
        ...
        (
            <Form className="items-center bg-[#F1E1D0] p-3 pt-[50px] w-[550px] h-[400px] shadow-lg text-black flex flex-col">
                ...
                <button className="btn btn-primary bg-white text-black w-full" type="submit">
                    {isSubmitting ? (
