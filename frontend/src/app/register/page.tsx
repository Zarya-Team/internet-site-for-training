    ...
    <div className='container mx-auto mt-6 justify-center flex flex-col h-screen items-center'>
        ...
        (
            <Form className="items-center bg-[#F1E1D0] p-3 pt-[50px] w-[550px] h-[450px] max-sm:w-[300px] max-sm:h-[300px] max-sm:pt-[30px] shadow-lg text-black flex flex-col">
                ...
                <button className="btn btn-primary bg-white w-[300px] mb-[30px] max-md:w-[200px] max-md:h-[380px] text-black" type="submit">
                    {isSubmitting ? (
              ...
              <a className="btn btn-primary bg-white w-[300px] max-md:w-[200px] max-md:h-[380px] text-black" href="/login">Авторизация</a>
            </Form>
        )}
        </Formik>
    </div>
