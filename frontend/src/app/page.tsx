...
export default function Home() {
  ...
  const ingrs = ['200 г рамена (японские лапша)','1 литр куриного бульона', '2 ст. ложки соевого соуса']
  const cook = ['Сварите рамен согласно инструкции на упаковке.','Отцедите','В большой кастрюле смешайте куриный бульон, соевый соус, мирин, имбирь и прогрейте на среднем огне.', 'Разложите рамен по мискам, добавьте бульон, а затем остальные ингредиенты (лук, шпинат, яйца и курицу).']
      ...
      <Image src='/Ramen.png' alt='Блюдо' width={1024} height={701} className='rounded-t-[3rem]'></Image>
        <div className='bg-[#F1E1D0] rounded-b-[3rem]'>
           <div className='flex justify-between items-center mx-[60px] mt-12'>
              <span className='text-[35px] text-black' style={{fontFamily:'IBM Plex Serif', fontWeight:'700'}}>Рамэн</span>
              <AiFillHeart size={40} fill={'black'} stroke={'black'} />
           </div>
           <div className='mx-[60px]'>
           <span className='text-[25px] text-black' style={{fontFamily:'IBM Plex Serif', fontWeight:'400',fontStyle:'italic'}}>Японское блюдо с пшеничной лапшой.</span>
           </div>
